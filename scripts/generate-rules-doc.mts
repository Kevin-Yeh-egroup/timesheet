  ...
  sections: [{
    ...
    children: [
      ...
      mkTable(
        ["類別", "Emoji", "時間型態", "歸因說明"],
        [
          ["工作", "💼", "生產型",  "調整時間 30% + 強化能力 70%"],
          ["學習", "📚", "成長型",  "增加技能 50% + 增加知識 50%"],
          ["副業", "🌱", "成長型",  "增加技能 100%"],
          ["人際", "💛", "關係型",  "運用人脈 100%"],
          ["休息", "🌿", "恢復型",  "增加體力 100%（被動恢復）"],
          ["鍛鍊", "🏃", "恢復型",  "增加體力 100%（主動投資體能）"],
        ]
      ),
      blank(),
      h3("資產累積點數公式"),
      ...
      blank(),
      p("說明：工作時數分配給「調整時間 30%」+「強化能力 70%」；學習時數分配給「增加技能 50%」+「增加知識 50%」；休息與鍛鍊皆 100% 歸入「增加體力」（區別在於一個是被動恢復，一個是主動投資）。"),
